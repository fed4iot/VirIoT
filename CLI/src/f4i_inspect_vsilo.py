...
def init_args(parser):
    ...
    parser.add_argument('-v', action='store', dest='vSiloID',
                        help='vSiloID (default: tenant1_Silo1)', default='tenant1_Silo1')


def run(args):
    url = args.controllerUrl + "/inspectVirtualSilo"

    payload = "{\n\t\"vSiloID\":\"" + args.vSiloID + "\"\n}"
    printj(payload)
