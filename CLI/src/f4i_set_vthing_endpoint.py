...
def init_args(parser):
    ...
    parser.add_argument('-e', action='store', dest='endpoint',
                        help='the vthing http endpoint (e.g. https://fed4iot.org), "dummy" keyword used to send back a void file (default: dummy)', default='dummy')
    parser.set_defaults(func=run)


def run(args):
    url = args.controllerUrl + "/setVThingEndpoint"
