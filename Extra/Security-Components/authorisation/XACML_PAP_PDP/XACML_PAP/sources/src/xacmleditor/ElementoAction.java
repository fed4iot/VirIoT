 ...
 * @version 1.3
 ****************************************************************/
public class ElementoAction
    extends ElementoXACML {

  public static final String TIPO_ACTION="Action";

  public ElementoAction(Map ht) {
    super.setTipo(TIPO_ACTION);
  ...
  public String[] getAllowedChild() {
    String[] allowedChild = {"ActionMatch"};
  return allowedChild;
}
