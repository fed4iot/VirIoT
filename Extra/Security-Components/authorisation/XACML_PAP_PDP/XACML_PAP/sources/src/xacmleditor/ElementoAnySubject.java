...
/** This class represents the XACML AnySubject elements.
 *
 * @author Alberto Jiménez Lázaro y Pablo Galera Morcillo
 * @version 1.3
 ****************************************************************/
public class ElementoAnySubject extends ElementoXACML {

	public static final String TIPO_ANY_SUBJECT = "AnySubject";

	public ElementoAnySubject(Map ht) {
		super.setTipo(TIPO_ANY_SUBJECT);
