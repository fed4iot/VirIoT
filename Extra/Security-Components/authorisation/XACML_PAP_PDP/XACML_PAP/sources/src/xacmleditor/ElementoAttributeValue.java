...
/** This class represents the XACML AttributeValue Element.
 *
 * @author Alberto Jiménez Lázaro y Pablo Galera Morcillo
 * @version 1.3
 ****************************************************************/
public class ElementoAttributeValue
    extends ElementoXACML {

  public static final String TIPO_ATTRIBUTEVALUE="AttributeValue";

  public ElementoAttributeValue(Map ht) {
    super.setTipo(TIPO_ATTRIBUTEVALUE);
