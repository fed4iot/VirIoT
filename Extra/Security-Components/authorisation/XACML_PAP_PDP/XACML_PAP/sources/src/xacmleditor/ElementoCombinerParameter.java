 ...
 * @version 1.3
 ****************************************************************/
public class ElementoCombinerParameter
    extends ElementoXACML {

  public static final String TIPO_COMBINERPARAMETER="CombinerParameter";

  public ElementoCombinerParameter(Map ht) {
    super.setTipo(TIPO_COMBINERPARAMETER);
    super.setAtributos(ht);
  }

  public String getID() {
    return (String)super.getAtributos().get("ParameterName");
  }
