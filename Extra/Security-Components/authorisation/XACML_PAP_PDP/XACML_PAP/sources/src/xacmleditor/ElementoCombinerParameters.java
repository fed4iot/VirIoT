 ...
 * @version 1.3
 ****************************************************************/
public class ElementoCombinerParameters
    extends ElementoXACML {

  public static final String TIPO_COMBINERPARAMETERS="CombinerParameters";

  public ElementoCombinerParameters(Map ht) {
    super.setTipo(TIPO_COMBINERPARAMETERS);
