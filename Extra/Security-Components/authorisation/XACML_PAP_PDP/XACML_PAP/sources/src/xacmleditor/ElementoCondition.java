...
/** This class represents the XACML Condition Element.
 *
 * @author Alberto Jiménez Lázaro y Pablo Galera Morcillo
 * @version 1.3
 ****************************************************************/
public class ElementoCondition
    extends ElementoXACML {

  public static final String TIPO_CONDITION="Condition";

  public ElementoCondition(Map ht) {
    super.setTipo(TIPO_CONDITION);
