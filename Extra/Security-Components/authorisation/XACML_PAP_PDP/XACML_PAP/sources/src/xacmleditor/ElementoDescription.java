...
/** This class represents the XACML Description Element.
 *
 * @author Alberto Jiménez Lázaro y Pablo Galera Morcillo
 * @version 1.3
 ****************************************************************/
public class ElementoDescription
    extends ElementoXACML {

  public static final String TIPO_DESCRIPTION="Description";

  public ElementoDescription(Map ht) {
    super.setTipo(TIPO_DESCRIPTION);
