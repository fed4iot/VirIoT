 ...
 * @version 1.3
 ****************************************************************/
public class ElementoEnvironmentMatch
    extends ElementoMatch {

  public static final String TIPO_ENVIRONMENTMATCH="EnvironmentMatch";

  public ElementoEnvironmentMatch(Map ht) {
    super.setTipo(TIPO_ENVIRONMENTMATCH);
  ...
  public int getPosicion(ElementoXACML e) {
    ...
    else if(e.getTipo().equals("EnvironmentAttributeDesignator")) return 2;
    return super.getPosicion(e);
  }

  public String[] getAllObligatory() {
    String[] AllObligatory = {"AttributeValue","EnvironmentAttributeDesignator" };
