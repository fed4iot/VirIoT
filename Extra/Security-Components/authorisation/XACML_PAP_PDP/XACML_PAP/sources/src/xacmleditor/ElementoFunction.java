...
/** This class represents the XACML Function Element.
 *
 * @author Alberto Jiménez Lázaro y Pablo Galera Morcillo
 * @version 1.3
 ****************************************************************/
public class ElementoFunction
    extends ElementoXACML {


  public static final String TIPO_FUNCTION="Function";


  public ElementoFunction(Map ht) {
    super.setTipo(TIPO_FUNCTION);
