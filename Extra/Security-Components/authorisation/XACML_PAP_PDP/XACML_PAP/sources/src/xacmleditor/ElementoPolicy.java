...
public class ElementoPolicy
  ...
  public int getPosicion(ElementoXACML e) {
    ...
    else if(e.getTipo().equals("RuleCombinerParameters")) return 4;
    else if(e.getTipo().equals("VariableDefinition")) return 4;
    else if(e.getTipo().equals("Rule")) return 4;
