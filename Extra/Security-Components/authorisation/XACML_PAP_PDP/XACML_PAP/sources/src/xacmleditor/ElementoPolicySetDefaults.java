...
/** This class represents the XACML PolicySetDefaults element.
 *
 * @author Alberto Jiménez Lázaro y Pablo Galera Morcillo
 * @version 1.3
 ****************************************************************/
public class ElementoPolicySetDefaults
    extends ElementoXACML {

  public static final String TIPO_POLICYSETDEFAULTS="PolicySetDefaults";

  public ElementoPolicySetDefaults(Map ht) {
    super.setTipo(TIPO_POLICYSETDEFAULTS);
  ...
  public int getMaxNumChild(ElementoXACML e) {
    if(e.getTipo().equals("XPathVersion")) return 1;
