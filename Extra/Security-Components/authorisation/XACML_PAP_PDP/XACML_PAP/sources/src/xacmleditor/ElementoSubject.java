...
/** This class represents the XACML Subject Element.
 *
 * @author Alberto Jiménez Lázaro y Pablo Galera Morcillo
 * @version 1.3
 ****************************************************************/
public class ElementoSubject
    extends ElementoXACML {

  public static final String TIPO_SUBJECT="Subject";

  public ElementoSubject(Map ht) {
    super.setTipo(TIPO_SUBJECT);
  ...
  public String[] getAllowedChild(){
     String[] allowedChild={"SubjectMatch"};
     return allowedChild;
  }
