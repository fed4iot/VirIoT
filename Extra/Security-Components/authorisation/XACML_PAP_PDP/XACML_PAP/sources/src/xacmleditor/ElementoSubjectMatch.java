 ...
 * @version 1.3
 ****************************************************************/
public class ElementoSubjectMatch
  ...
  public int getPosicion(ElementoXACML e) {
    ...
    else if(e.getTipo().equals("SubjectAttributeDesignator")) return 2;
  ...
  public String[] getAllObligatory() {
    String[] AllObligatory = {"AttributeValue","SubjectAttributeDesignator" };
