...
/* **************************************************************
 * Name: ElementoVariableReference
 *
 * Description: */
/** This class represents the XACML VariableReference Element.
 *
 * @author Alberto Jiménez Lázaro y Pablo Galera Morcillo
 * @version 1.3
 ****************************************************************/
public class ElementoVariableReference
    extends ElementoXACML {


  public static final String TIPO_VARIABLEREFERENCE="VariableReference";


  public ElementoVariableReference(Map ht) {
    super.setTipo(TIPO_VARIABLEREFERENCE);
