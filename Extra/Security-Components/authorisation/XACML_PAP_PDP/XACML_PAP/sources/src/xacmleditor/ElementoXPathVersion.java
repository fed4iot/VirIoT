...
/* *************************************************************************
 * Title: ElementoXPathVersion
 *
 * Description:*//** This object represents the XACML XPathVersion element.
 *
 * @author Alberto Jiménez Lázaro,Pablo Galera Morcillo
 *
 * @version 1.3
 ***************************************************************************/
public class ElementoXPathVersion
    extends ElementoXACML {

  public static final String TIPO_XPATHVERSION="XPathVersion";

  public ElementoXPathVersion(Map ht) {
    super.setTipo(TIPO_XPATHVERSION);
