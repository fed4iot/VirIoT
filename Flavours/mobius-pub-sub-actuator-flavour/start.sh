...
/usr/bin/screen -S v_silo_controller -s /bin/bash -t win0 -A -d -m

screen -S mobius -p win0 -X stuff $'node mobius.js\n'
sleep 7
screen -S v_silo_controller -p win0 -X stuff $'/usr/bin/python3 /app/mobius_pub_sub_silo_controller.py\n'
