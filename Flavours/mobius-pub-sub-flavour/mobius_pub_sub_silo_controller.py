...
import F4Im2m
from f4Im2mPubSub import OM2MPubSub
...
MOBIUS_MQTT_BROKER_IP = "127.0.0.1"
MOBIUS_MQTT_BROKER_PORT = 1883
mobius_mqtt_client = OM2MPubSub(MOBIUS_MQTT_BROKER_IP, MOBIUS_MQTT_BROKER_PORT)
        ...
        for key in entity:
            if key not in ["id", "type"]:
                ...
                if sub_container_uri in containers_uri:
                    mobius_mqtt_client.create_cin_mqtt(sub_container_uri, origin, str(value), usecsebase, ae_rn)
                else:
