...
screen -S api-gateway -p win0 -X stuff $'java -Xms512m -jar stellio/api-gateway-0.5.0.jar\n'
sleep 30
echo "Gateway started"
echo "Starting search service"
screen -S search-service -p win0 -X stuff $'java -Xms512m -jar stellio/search-service-0.5.0.jar\n'
sleep 30
echo "Search service started"
echo "Starting subscription service"
screen -S subscription-service -p win0 -X stuff $'java -Xms512m -jar stellio/subscription-service-0.5.0.jar\n'
sleep 30
