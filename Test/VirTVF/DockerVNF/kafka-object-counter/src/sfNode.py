...
if __name__ == '__main__':
    ...
    #interest = "kafka:/carCounter/yologpu/camera"
    #targetService = "yologpu"
    #targetTag = "car"
    ...
    if (funcList[0] == "ccn:"):
        ...
        with cefpyco.create_handle() as handle:
            ...
            while True:
                ...
                ##### result is string
                #result = callSF.callService(content, interest, HOST, SERVICE, revSize)
                result = counter.callObjectCounter(interest, rxData, targetService, targetTag)
