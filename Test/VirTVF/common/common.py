...
def drawFace(img, data):
    ...
    if face != "":
        ...
        for i in range(len(face)):
            ...
            #gender = face[i]['boundingBox']['gender']
            #age = face[i]['boundingBox']['age']
...
def imageWithResultWriter(data, interest):
    ...
    with open("/var/www/html/tvf/"+outFileName+".jpg", "wb") as f:
        f.write(byteImg)

    img = cv2.imread("/var/www/html/tvf/"+outFileName+".jpg", 1)
    ...
    if os.path.exists("/var/www/html/tvf/"+outFileName+"_result.jpg") == True:
        os.remove("/var/www/html/tvf/"+outFileName+"_result.jpg")
    cv2.imwrite("/var/www/html/tvf/"+outFileName+"_result.jpg", img)
