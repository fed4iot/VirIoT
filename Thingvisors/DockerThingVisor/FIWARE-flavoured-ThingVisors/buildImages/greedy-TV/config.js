...
module.exports = {
    ...
    noGreedyListTypes: [['Sensor'],['Punto']],
    //TODO:
    //Improvement in consideration (NO SUPPORTED):
    ...
    noGreedyListTypesAttributes: [[['nombre','libres','totales','geoposicion']],[['nombre','geoposicion']]],
    ...
    noGreedyListDestTypes: [['parkingsite'],['parkingmeter']],
    ...
    noGreedyListDestAttributesTypes: [[['name','numSpacePC','totSpacePCCapacity','location']],[['name','location']]],
