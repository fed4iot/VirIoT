...
//    MQTTbrokerPort: process.env.MQTTbrokerPort,
    ...
    noGreedyListTypesAttributes: [[['descripcion','libres','ocupados','geoposicion']]],
    ...
    noGreedyListDestTypes: [['BikeStop']],
    ...
    noGreedyListDestAttributesTypes: [[['name','free','occupied','location']]],
