...
class FetcherThread(Thread):    
    ...
    def run(self):
        def run_main(sensorInfo, data):
            if type(data) is dict and sensorInfo["sensorType"] == "animalDetector1" and type(data["animalPresent"]["value"]) is bool:
                data["animalPresent"]["value"] = str(data["animalPresent"]["value"])
        ...
        url = "http://202.13.160.82:1026/v2/entities/"
        # define sensor data
        sensorInfos = [
            {
                "location":"KIT",
            ...
            },
            {
                ...
                "app": "detectedObject",
                "sensorName":"HakusanRainGauge",
                "sensorNumber": "001"
            },
            {
                "location":"KIT",
                "sensor":"Illuminometer01",
                "sensorType": "illuminometer",
                "app": "detectedObject",
                "sensorName":"HakusanIlluminometer",
                "sensorNumber": "001"
            },
            {
                "location":"KIT",
                "sensor":"AnimalDetector1_01",
                
                "sensorType": "animalDetector1",
                "app": "detectedObject",
                "sensorName":"HakusanAnimalDetector1",
                "sensorNumber": "001"
            },
            {
                "location":"KIT",
                "sensor":"AnimalDetector2_01",
                "sensorType": "animalDetector2",
                "app": "detectedObject",
                "sensorName":"HakusanAnimalDetector2",
                "sensorNumber": "001"
            },
            {
                "location":"KIT",
        ...
        while True:
            ...
            for sensorInfo in sensorInfos:
                for sensorData in response:
                    if sensorData["id"] == "urn:ngsi-ld:" + sensorInfo["sensorName"] + ":" + sensorInfo["sensorNumber"]:
                        run_main(sensorInfo, sensorData)
                        break
                # else:
                #     run_main(sensorInfo, "no sensorData")
